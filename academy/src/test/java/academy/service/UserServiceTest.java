...
public class UserServiceTest {
	...
	void testFindByEmail() {
		...
		User user = new User("new@new", "new", "user", UserRole.USER, "1");
	...
	void testFindByEmailNotFound() {
		User user = new User("new@new", "new1", "user1", UserRole.USER, "1");
	...
	void testFindById() {
		User user = new User(0, "new@new2", "new", "user", UserRole.USER, "1");
	...
	void testFindAll() {
		User user3 = new User("new@new3", "new3", "user3", UserRole.USER, "1");
		User user4 = new User("new@new4", "new4", "user4", UserRole.USER, "1");
	...
	void testSave() {
		User user = new User(1, "new@new5", "new3", "user3", UserRole.USER, "1");
